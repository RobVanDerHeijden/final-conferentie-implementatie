...
class BeoordeelAanmeldingController extends Controller
{
    public function postacceptaanmelding(Request $request)
    {
        ...
        DB::table('aanmeldings')->where('id', $request["aanmelding"])->update(['status' => "Geaccepteerd"]);
...
/*        $ticket[] = DB::table('tickets')->get();
    ...
    {
        $aanmelding = DB::table('aanmeldings')->where('id', $request["aanmeldingsId"])->first();
        
        DB::table('aanmeldings')->where('id', $request["aanmeldingsId"])->update(['status' => "Geaccepteerd"]);
        DB::table('aanmeldings')->where('id', $request["aanmeldingsId"])->update(['kosten' => $aanmelding->tegenBod]);
    ...
    public function postWeigerTegenbod(Request $request)
    {
        ...
        DB::table('aanmeldings')->where('id', $request["aanmeldingsId"])->delete();
